...
- **Major Datasets**: `Bangla2B+` (BUET CSE NLP, 27.5 GB web text from 110 Bangladesh sites, CC-BY-NC-4.0), `IndicCorp v2 (Bengali)` (AI4Bharat, 1.2B tokens, CC0-1.0), `OSCAR Bengali`.
...
- **Major Datasets**: `BanglaNMT` (BUET CSE NLP, 2.75M parallel pairs, CC-BY-NC-4.0), `Bharat Parallel Corpus Collection (BPCC) Bengali Split` (AI4Bharat, CC-BY-4.0).
...
- **Major Datasets**: `BanglaTLit` (Fahim et al., 2024; EMNLP 2024 Findings; 42.7k annotated pairs + 245.7k PT corpus, MIT License), `BnSentMix` (Alam et al., 2025; LoResLM 2025; 20,000 code-mixed samples, MIT License).
...
| `AZAD-SYNTAX-1984` | Bakkototto (Bangla Syntax) | 1 vol (320 pp) | All-Rights-Reserved | Derived features only | `VERIFIED` |
| `THOMPSON-GRAM-2012`| Bengali: Comprehensive Grammar | 1 vol (672 pp) | All-Rights-Reserved | Derived features only | `VERIFIED` |
...
| `BANGLA2B-2022` | Bangla2B+ Pretraining Corpus | 27.5 GB text | CC-BY-NC-4.0 | Derived features only | `VERIFIED` |
| `BANGLANMT-2020` | BanglaNMT Parallel Corpus | 2.75M pairs | CC-BY-NC-4.0 | Derived features only | `VERIFIED` |
...
| `BNSENTMIX-2025` | BnSentMix Code-Mixed Dataset | 20,000 sentences | MIT | Open redistribution | `VERIFIED` |
| `BPCC-BENGALI-2023` | BPCC Bengali Parallel Component | Mined + Human split | CC-BY-4.0 | Open redistribution | `PARTIALLY_VERIFIED` |
| `SOAS-SYLHETI-2014` | SOAS Sylheti Documentation | Journal Monograph | All-Rights-Reserved | Derived features only | `VERIFIED` |
