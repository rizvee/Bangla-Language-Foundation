...
UPOS_MAPPINGS: List[CrosswalkEntry] = [
    ...
    CrosswalkEntry("pos", "noun", UDCategory.UPOS, "NOUN", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_PUD, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "PUD treebank specification; unreleased upstream repository data"),
    ...
    CrosswalkEntry("pos", "proper_noun", UDCategory.UPOS, "PROPN", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_PUD, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "PUD treebank specification; unreleased upstream repository data"),
    ...
    CrosswalkEntry("pos", "pronoun", UDCategory.UPOS, "PRON", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_PUD, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "PUD treebank specification; unreleased upstream repository data"),
    # Verbal
    ...
    CrosswalkEntry("pos", "auxiliary_verb", UDCategory.UPOS, "AUX", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_PUD, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "PUD treebank specification; unreleased upstream repository data"),
    ...
    CrosswalkEntry("pos", "postposition", UDCategory.UPOS, "ADP", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_PUD, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "PUD treebank specification; unreleased upstream repository data"),
    ...
    CrosswalkEntry("pos", "coordinating_conjunction", UDCategory.UPOS, "CCONJ", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "Unobserved in 56-sentence BRU sample; standard UD UPOS"),
...
DEPREL_MAPPINGS: List[CrosswalkEntry] = [
    ...
    CrosswalkEntry("dependency", "temporal_oblique", UDCategory.DEPREL, "obl:tmod", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "Unobserved in 56-sentence BRU sample; standard UD obl subtype"),
    ...
    CrosswalkEntry("dependency", "serial_verb_compound", UDCategory.DEPREL, "compound:svc", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "Unobserved in 56-sentence BRU sample; standard UD compound subtype"),
    ...
    CrosswalkEntry("dependency", "classifier_attachment", UDCategory.DEPREL, "clf", CrosswalkRelation.CLOSE, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.UD_SPEC_COMPATIBLE, "Unobserved in 56-sentence BRU sample; UD clf dependency relation"),
    ...
    # Empirical additions observed in UD_Bengali-BRU micro-ingestion
    CrosswalkEntry("dependency", "punctuation", UDCategory.DEPREL, "punct", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "adverbial_modifier", UDCategory.DEPREL, "advmod", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "adjectival_modifier", UDCategory.DEPREL, "amod", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "possessive_nominal_modifier", UDCategory.DEPREL, "nmod:poss", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "compound_nominal", UDCategory.DEPREL, "compound", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "determiner", UDCategory.DEPREL, "det", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "auxiliary", UDCategory.DEPREL, "aux", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "conjunct", UDCategory.DEPREL, "conj", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "marker", UDCategory.DEPREL, "mark", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "open_clausal_complement", UDCategory.DEPREL, "xcomp", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "clausal_complement", UDCategory.DEPREL, "ccomp", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "vocative", UDCategory.DEPREL, "vocative", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "parataxis", UDCategory.DEPREL, "parataxis", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "fixed_expression", UDCategory.DEPREL, "fixed", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "relative_clause", UDCategory.DEPREL, "acl:relcl", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
    CrosswalkEntry("dependency", "passive_nominal_subject", UDCategory.DEPREL, "nsubj:pass", CrosswalkRelation.EXACT, UDTreebank.UD_BENGALI_BRU, UDEvidenceStatus.OBSERVED_IN_BENGALI_BRU),
